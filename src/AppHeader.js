...
function AppHeader() {
    ...
    return(
      ...
      <div className="app-header-left">
        ...
        <p className="app-name">Schedule UX</p>
      ...
      <div className="app-header-right">
        ...
        <button className="add-btn" title="Add New patient">
        ...
        <button className="profile-btn">
          <img src="https://images.unsplash.com/photo-1559839734-2b71ea197ec2?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80"/>
          <span>Dr. Emmy Lou</span>
        </button>
      </div>
